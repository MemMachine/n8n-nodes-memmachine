...
exports.exportToJaeger = exports.convertToOTLP = void 0;
function traceEntryToOTLPSpan(trace) {
    const startTimeNanos = new Date(trace.timestamp).getTime() * 1000000;
    let endTimeNanos;
    if (trace.duration && trace.duration > 0) {
        endTimeNanos = startTimeNanos + trace.duration * 1000000;
    }
    else {
