import type { TracingConfig as TracingConfigType, OperationType, ResourceType } from './traceTypes';
...
export declare class MemoryTracer {
    ...
    startOperation(source: ResourceType, type: OperationType, metadata?: any, parentTraceId?: string): string;
